...
export class PlantationMapPage implements OnInit {
        ...
        this.networkService.onNetworkChange().subscribe((status: ConnectionStatus) => {
          if ((plt.coordx == null) && (plt.coordy == null)) {
            ...
            if (status == ConnectionStatus.Online) {
              setTimeout(() => {
                this.map_Online(plt.coordx, plt.coordy, 1);
              }, 600);
            }
            if (status == ConnectionStatus.Offline) {
              setTimeout(() => {
                this.map_Offline(plt.coordx, plt.coordy, 1);
              }, 600);
            }
          }
        ...
        () => {
          ...
          this.db.lastLogedUser().then(usr => {
            ...
            this.geolocation.getCurrentPosition().then((resp) => {
              var ticker = 0;
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'coordx', this.coordx, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'coordy', this.coordy, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              if (ticker == 1) {
      ...
      this.db.savePlantationPolygon(this.polygonFeature, this.area_acres, this.area, this.surface_ha, val)
        .then(() => {
          ...
          this.db.lastLogedUser().then(usr => {
            ...
            this.geolocation.getCurrentPosition().then((resp) => {
              var ticker = 0;
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'area_acres', this.area_acres, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'area', this.area, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'surface_ha', this.surface_ha, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'modified_by', this.user.id_contact, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, val, this.plantation.plantationsite_id, this.id_contact, 'modified_date', date, 'plantation', date, resp.coords.latitude, resp.coords.longitude, val, this.id_project, this.id_task, null, null, null, null, null, null, null, null, null, null).then(() => { ticker = 1; });
  ...
  pathActionStart() {
    ...
    this.subscription = this.watch.subscribe((data) => {
      this.pathway.push([data.coords.longitude, data.coords.latitude]);

      this.translate.get('POINT_ADDED').subscribe(value => {
        this.toastAlert(i + value);
      });
        ...
        .then(() => {
          ...
          this.db.lastLogedUser().then(usr => {
            ...
            this.geolocation.getCurrentPosition().then((resp) => {
              ...
              var ticker = 0;
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'id_agent', this.user.id_contact, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, this.paths.id_path, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'id_company', this.id_company, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, this.paths.id_path, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'geom_json', path_json, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, this.paths.id_path, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'modified_by', this.user.id_contact, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, this.paths.id_path, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'modified_date', date, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, this.paths.id_path, null).then(() => { ticker = 1; });
        ...
        .then(() => {
          ...
          this.db.lastLogedUser().then(usr => {
            ...
            this.geolocation.getCurrentPosition().then((resp) => {
              ...
              var ticker = 0;
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'id_agent', this.user.id_contact, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, newId, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'id_company', this.id_company, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, newId, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'geom_json', path_json, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, newId, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'modified_by', this.user.id_contact, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, newId, null).then(() => { ticker = 1; });
              this.db.addTicker(usr.id_contact, plantation_id, this.plantation.plantationsite_id, this.id_contact, 'modified_date', date, 'plantation_lines', date, resp.coords.latitude, resp.coords.longitude, null, this.id_project, this.id_task, null, null, null, null, null, null, null, null, newId, null).then(() => { ticker = 1; });
  ...
  captureVideo() {
    ...
    this.mediaCapture.captureVideo(options).then((res: MediaFile[]) => {
      ...
      var toDirectory = this.file.externalRootDirectory + 'icollect/plantations';
  ...
  moveFile(description, correctPath, currentName, id_plantation) {
    ...
    let newPath = this.file.externalRootDirectory + 'icollect/plantations';
